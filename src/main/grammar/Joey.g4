...
conditional_statement
    ...
    condition ((BEGIN  statement eol (statement eol)* END)
    | (NEWLINE statement)) (eol? else_if_statement)* (eol? else_statement)?
    ;
...
else_if_statement
    : ELSE IF {System.out.println("Conditional : else if");}
    condition
